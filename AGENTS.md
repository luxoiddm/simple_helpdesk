# SupportDesk Project Context & Rules

## Project Overview
SupportDesk is a support ticket management system built with React (Vite), Express, and SQLite. It features real-time updates via Socket.IO and a modern UI using Tailwind CSS and Framer Motion.
